...
constexpr void get_pbr_forward_pass_indirect(ShaderInfoData<2>& out, const std::string& light_uniforms, const std::string& light_functions, const std::string& defines)
{
...
constexpr void get_pbr_forward_pass_normal(ShaderInfoData<2>& out, const std::string& light_uniforms, const std::string& light_functions, const std::string& defines)
{
    std::vector<char> pbr_file = read_file<char>("res/shaders/forward_pass/pbr_combined.glsl");
    std::string_view pbr_file_view = { pbr_file.data(), pbr_file.size() };
...
constexpr void get_shadow_pass_basic_shaders(ShaderInfoData<2>& out, const std::string& defines)
{
...
constexpr void get_directional_cascade_shader(ShaderInfoData<2>& out, const std::string& defines)
{
...
constexpr void get_directional_cascade_shader_geometry(ShaderInfoData<3>& out, const std::string& defines, u32 cascade_count)
{
...
constexpr void get_shadow_pass_point_shaders(ShaderInfoData<2>& out, const std::string& defines)
{
...
constexpr void get_shadow_pass_point_geometry_shaders(ShaderInfoData<3>& out, const std::string& defines)
{
